    ...
    BOOST_AUTO_TEST_CASE(comment_apply) {
        try {
         ...
         //BOOST_REQUIRE( alice_comment.json_metadata == op.json_metadata );
            ...
            BOOST_REQUIRE(
                bob_comment.cashout_time == bob_comment.created + STEEMIT_CASHOUT_WINDOW_SECONDS);
            ...
            BOOST_REQUIRE(
                sam_comment.cashout_time == sam_comment.created + STEEMIT_CASHOUT_WINDOW_SECONDS);
        ...
        try {
...

            {
                ...
                BOOST_REQUIRE(alice_comment.cashout_time ==
                              alice_comment.created + STEEMIT_CASHOUT_WINDOW_SECONDS);
